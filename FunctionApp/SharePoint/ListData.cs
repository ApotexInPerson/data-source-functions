    ...
    public class ListData
    {
            ...
            ILogger log)
        {
            ...
            var queryOptions = new List<QueryOption>
            {
                ...
                new QueryOption("filter", $"fields/Title eq '{req.Query["floor"]}' AND fields/Weekday eq '{req.Query["weekday"]}' AND fields/WeekNumber eq '{req.Query["weeknumber"]}' AND fields/Bookings le '{req.Query["bookings"]}'"),
                new QueryOption("expand", "fields(select=Title,Time)")
            };
